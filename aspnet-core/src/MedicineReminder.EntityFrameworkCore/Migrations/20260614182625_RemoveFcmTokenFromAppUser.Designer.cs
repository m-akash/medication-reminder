...
namespace MedicineReminder.Migrations
{
    ...
    [Migration("20260614182625_RemoveFcmTokenFromAppUser")]
    partial class RemoveFcmTokenFromAppUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedicineReminder.Entities.AppUser", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("MedicineReminder.Entities.Medicine", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("OriginalTotalPills")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedicineReminder.Entities.MedicineTakenDay", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("MedicineId", "Date")
                        .IsUnique();

                    b.ToTable("AppMedicineTakenDays", (string)null);
                });

            modelBuilder.Entity("MedicineReminder.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MedicineReminder.Entities.Reminder", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MedicineReminder.Entities.ReminderTime", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppReminderTimes", (string)null);
                });

            modelBuilder.Entity("MedicineReminder.Entities.UserSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("MedicineDefaultsJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("AppUserSettings", (string)null);
                });
            ...
            modelBuilder.Entity("MedicineReminder.Entities.Medicine", b =>
                {
                    b.HasOne("MedicineReminder.Entities.AppUser", "User")
                        .WithMany("Medicines")
            ...
            modelBuilder.Entity("MedicineReminder.Entities.MedicineTakenDay", b =>
                {
                    b.HasOne("MedicineReminder.Entities.Medicine", "Medicine")
                        .WithMany("MedicineTakenDays")
            ...
            modelBuilder.Entity("MedicineReminder.Entities.ReminderTime", b =>
                {
                    b.HasOne("MedicineReminder.Entities.Reminder", "Reminder")
                        .WithMany("Times")
            ...
            modelBuilder.Entity("MedicineReminder.Entities.UserSettings", b =>
                {
                    b.HasOne("MedicineReminder.Entities.AppUser", "User")
                        .WithOne("Settings")
                        .HasForeignKey("MedicineReminder.Entities.UserSettings", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MedicineReminder.Entities.Medicine", b =>
                {
                    b.Navigation("MedicineTakenDays");
