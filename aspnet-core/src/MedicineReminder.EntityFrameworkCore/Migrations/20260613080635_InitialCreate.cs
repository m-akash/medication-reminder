        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalDurationDays = table.Column<int>(type: "int", nullable: false),
                    Instructions = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    TotalPills = table.Column<int>(type: "int", nullable: false),
                    OriginalTotalPills = table.Column<int>(type: "int", nullable: false),
                    PillsPerDose = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppMedicines_AppAppUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicineName = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppNotifications_AppAppUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AppAppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicineDefaultsJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PrivacyJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppUserSettings_AppAppUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AppAppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "AppMedicineTakenDays",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MedicineId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Date = table.Column<DateTime>(type: "date", nullable: false),
                    Taken = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false, defaultValue: "0-0-0"),
                    RemindersSent = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false, defaultValue: "0-0-0")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppMedicineTakenDays", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppMedicineTakenDays_AppMedicines_MedicineId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppReminders_AppMedicines_MedicineId",
                        column: x => x.MedicineId,
                        principalTable: "AppMedicines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppReminderTimes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppReminderTimes_AppReminders_ReminderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppAppUsers_Email",
                table: "AppAppUsers",
                column: "Email",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppMedicines_AppUserId",
                table: "AppMedicines",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppMedicineTakenDays_MedicineId_Date",
                table: "AppMedicineTakenDays",
                columns: new[] { "MedicineId", "Date" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppReminders_MedicineId",
                table: "AppReminders",
                column: "MedicineId");

            migrationBuilder.CreateIndex(
                name: "IX_AppReminderTimes_ReminderId",
                table: "AppReminderTimes",
                column: "ReminderId");
